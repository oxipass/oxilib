...
func GetFontAwesomeList() (faValues []string) {
	return *getFontAwesomeValues()
}

func CheckIfExistsFontAwesome(faCheckValue string) bool {
	for _, faFound := range *getFontAwesomeValues() {
...
var faCachedValues []string

func getFontAwesomeValues() (faValues *[]string) {
	if faCachedValues != nil {
		return &faCachedValues
	}
	faCachedValues = make([]string, 783)
	faCachedValues = []string{
		"fab fa-500px",
