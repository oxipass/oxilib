...
func (sdb *storageDB) dbDeleteItem(itemID int64) (err error) {
	if sdb.sTX == nil {
		return oxilib.formError(oxilib.BSERR00003DbTransactionFailed, "dbDeleteItem")
	}
...
func (sdb *storageDB) dbInsertItem(itemName string, itemIcon string) (itemID int64, err error) {
	if sdb.sTX == nil {
		return 0, oxilib.formError(oxilib.BSERR00003DbTransactionFailed, "dbInsertItem")
	}
	...
	if err != nil {
		return 0, oxilib.formError(oxilib.BSERR00006DbInsertFailed, err.Error(), "dbInsertItem")
	}
	...
	if errStmt != nil {
		return 0, oxilib.formError(oxilib.BSERR00006DbInsertFailed, errStmt.Error(), "dbInsertItem")
	}
	...
	errClose := stmt.Close()
	if errClose != nil {
		return 0, oxilib.formError(oxilib.BSERR00006DbInsertFailed, errClose.Error(), "dbInsertItem")
	}
...
func (sdb *storageDB) dbSelectAllItems(returnDeleted bool) (items []models.OxiItem, err error) {
	...
	if err != nil {
		return items, oxilib.formError(oxilib.BSERR00014ItemsReadFailed, err.Error())
	}
	defer func() {
		errClose := rows.Close()
		if errClose != nil {
			err = oxilib.formError(oxilib.BSERR00014ItemsReadFailed, err.Error(), errClose.Error())
		}
...
func (sdb *storageDB) dbUpdateItemName(itemID int64, newName string) (err error) {
	if sdb.sTX == nil {
		return oxilib.formError(oxilib.BSERR00003DbTransactionFailed, "dbUpdateItemName")
	}
	...
	errClose := stmt.Close()
	if errClose != nil {
		return oxilib.formError(oxilib.BSERR00018DbItemNameUpdateFailed, errClose.Error())
	}
	return nil
}
...
func (sdb *storageDB) dbGetItemById(itemId int64, withDeleted bool) (item models.OxiItem, err error) {
	...
	if err != nil {
		return item, oxilib.formError(oxilib.BSERR00014ItemsReadFailed, err.Error())
	}
	...
	return item, oxilib.formError(oxilib.BSERR00019ItemNotFound)
}
...
func (sdb *storageDB) dbUpdateItemIcon(itemID int64, newIcon string) (err error) {
	if sdb.sTX == nil {
		return oxilib.formError(oxilib.BSERR00003DbTransactionFailed, "dbUpdateItemIcon")
	}
	...
	errClose := stmt.Close()
	if errClose != nil {
		return oxilib.formError(oxilib.BSERR00026DbItemIconUpdateFailed, errClose.Error())
	}
	return nil
}
